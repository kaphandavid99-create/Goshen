...
export function AdminBookingLink() {
  ...
  const bookingUrl = `${typeof window !== "undefined" ? window.location.origin : ""}/shop/nipz#book`;
  ...
  return (
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-6">
      ...
      <p className="mb-4 text-sm text-amber-800">
        Copy and share this link with customers to take them directly to the booking form.
      </p>
